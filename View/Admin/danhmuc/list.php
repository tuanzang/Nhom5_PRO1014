    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href=" ../Controller/index_admin.php?request=manager">Quản Lý Danh Mục</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="table-data">
        <div class="todo">
            <div class="head">
                ...
                <a href="../Controller/index_admin.php?request=createbrand" class="btn btn-primary status pending btn-add-sp">Thêm danh mục</a>
            </div>
            <ul class="todo-list">
