                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-custom">
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav d-flex justify-content-around w-100">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-warning" href="../../../../Duan1_Project/Controller/index_user.php?request=cancel">Đã Hủy</a>
                                    </li>
                                </ul>
                             </div>
                        </nav>
            ...
            <div class="billing_details">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php if(!empty($list_cancel_bill )) :  ?>
                        <?php foreach( $list_cancel_bill as $value):extract($value)?>
