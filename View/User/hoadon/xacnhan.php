                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-custom">
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav d-flex justify-content-around w-100">
                                    <li class="nav-item">
                                        <a class="nav-link  text-warning" href="../../../../Duan1_Project/Controller/index_user.php?request=wait-confirm">Chờ Xác Nhận</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../../../../Duan1_Project/Controller/index_user.php?request=receive">Đang đóng gói và vận chuyển</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../../../../Duan1_Project/Controller/index_user.php?request=complete">Hoàn Thành</a>
                                    </li>
                                    <li class="nav-item">
            ...
            <div class="billing_details">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php if(!empty($list_bill_transport)) :  ?>
                        <?php foreach($list_bill_transport as $value):extract($value)?>
                            <div class="order_box mb-3 ">
                                <div class="row  border-bottom">
                                    ...
                                    <div class="col-2 justify-content-center my-auto text-center">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-2">
                                        <div class="d-inline">
                                            <a href="../../../../Duan1_Project/Controller/index_user.php?request=cancel-bill&id_bill=<?=$id_hoa_don?>" class="btn btn-danger">Hủy đơn hàng</a>
                                        </div>
                                    </div>
